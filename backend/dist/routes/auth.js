...
router.post('/signup', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 4:
                error_1 = _b.sent();
                return [2 /*return*/, res.json({ message: "все не ок", error: error_1.message })];
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 2:
                user = _b.sent();
                if (!user) {
                    return [2 /*return*/, res.json({ message: "все не ок c Именем" })];
                }
                return [4 /*yield*/, bcrypt.compare(password, user.password)];
            case 3:
                isValidPassword = _b.sent();
                if (!isValidPassword) {
                    return [2 /*return*/, res.json({ message: "все не ок c Паролем" })];
                }
                req.session.user = { userId: user.id, userName: user.name };
                res.json({ userId: user.id, userName: user.name });
                return [3 /*break*/, 5];
            case 4:
                error_2 = _b.sent();
                return [2 /*return*/, res.json({ message: "все не ок", error: error_2.message })];
            case 5: return [2 /*return*/];
        }
    });
}); });
